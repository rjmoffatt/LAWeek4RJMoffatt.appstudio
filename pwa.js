...
const cacheName = 'LAWeek4RJMoffatt-2021-02-24 15:12:29.910271'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4RJMoffatt'.length) === 'LAWeek4RJMoffatt') {
